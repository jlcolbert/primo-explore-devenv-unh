!(function i(o, a, r) {
  function s(t, e) {
    if (!a[t]) {
      ...
      (n = a[t] = { exports: {} }), o[t][0].call(n.exports, (e) => s(o[t][1][e] || e), n, n.exports, i, o, a, r);
    }
    return a[t].exports;
  }
...
})(
  {
    1: [
      function (e, t, n) {
        e("./js/external-search.module.js"), (t.exports = "externalSearch");
      },
      { "./js/external-search.module.js": 2 },
    ],
    2: [
      function (e, t, n) {
        angular
            ...
            controller: [
              ...
              function (e) {
                this.$onInit = function () {
                  e.setController(this.parentCtrl), e.addExtSearch();
                };
              },
            ],
          })
          .component("prmPageNavMenuAfter", {
            controller: [
              ...
              function (e) {
                this.$onInit = function () {
                  e.getController() && e.addExtSearch();
                };
              },
            ],
          })
          .component("prmFacetExactAfter", {
            bindings: { parentCtrl: "<" },
            template:
              '<div ng-if="name === \'External Search\'">          <div ng-hide="$ctrl.parentCtrl.facetGroup.facetGroupCollapsed">              <div class="section-content animate-max-height-variable">                  <div class="md-chips md-chips-wrap">                      <div ng-repeat="target in targets" aria-live="polite" class="md-chip animate-opacity-and-scale facet-element-marker-local4">                          <div class="md-chip-content layout-row" role="button" tabindex="0">                              <strong dir="auto" title="{{ target.name }}">                                  <a ng-href="{{ target.url + target.mapping(queries, filters) }}" target="_blank">                                      <img ng-src="{{ target.img }}" width="22" height="22" alt="{{ target.alt }}" style="vertical-align:middle;"> {{ target.name }}                                  </a>                              </strong>                          </div>                      </div>                  </div>              </div>          </div>      </div>',
            controller: [
              "$scope",
              "$location",
              "searchTargets",
              function (n, i, o) {
                this.$onInit = function () {
                  (n.name = this.parentCtrl.facetGroup.name), (n.targets = o);
                  const e = i.search().query;
                  const t = i.search().pfilter;
                  (n.queries = "[object Array]" === Object.prototype.toString.call(e) ? e : !!e && [e]),
                    (n.filters = "[object Array]" === Object.prototype.toString.call(t) ? t : !!t && [t]);
                };
              },
            ],
          })
          .factory("externalSearch", () => ({
            getController() {
              return this.prmFacetCtrl || !1;
            },
            setController(e) {
              this.prmFacetCtrl = e;
            },
            addExtSearch() {
              const e = this;
              var t = setInterval(() => {
                e.prmFacetCtrl.facetService.results[0] &&
                  "External Search" != e.prmFacetCtrl.facetService.results[0].name &&
                  ("External Search" !== e.prmFacetCtrl.facetService.results.name &&
                    e.prmFacetCtrl.facetService.results.unshift({
                      name: "External Search",
                      displayedType: "exact",
                      limitCount: 0,
                      facetGroupCollapsed: !1,
                      values: void 0,
                    }),
                  clearInterval(t));
              }, 100);
        ...
        (a = {}),
          (o.m = i = [
            ...
            function (e, t, n) {
              ...
              var n = '\n  <style>\n    help-menu-content-display { font-size: 140%; margin-bottom: 5px;}\n    #help-header { background-color: lightgrey; }\n    #help-content { padding: 0px 25px; }\n    prm-static-page > prm-static > div { display: none; }\n  </style>\n  <div id="help-header" class="md-toolbar-tools">'
                .concat(o, '</div>\n  <div id="help-content">')
                .concat(a, "</div>");
              const r = "primoExploreHelpMenuStudioConfig";
              const i = "help-menu-notification-indicator-dismissed";
              var s = {
                logToConsole: !1,
                publishEvents: !1,
                enableNotificationIndicator: !1,
                notificationIndicatorExpiration: 12096e5,
                ...
                list_of_elements: [
                  ...
                  {},
                  {
                    ...
                    description:
                      'brief description of material types, "scopes", and collections; may have submenus for each of the above; likely also link out to WordPress page with all PCI collections',
                  ...
                  {},
                  {
                    ...
                    title: "Guides",
                    description:
                      "info about research, subject, course, and how to guides; how to find in BULS by way of search and related more info links; link out to LibGuides home",
                  ...
                  {},
                  {
                    ...
                    title: "Query Builder",
                    description:
                      "placeholder for this, tbd functionality for future development; interim step may just be to have text demonstrating adv query syntax",
                  ...
                  },
                  {
                    ...
                    title: "Feedback",
                    description:
                      'directs to a new form to send feedback in the format of specific questions, e.g. "rate your experience", "did you find what you\'re looking for?", "send us your thoughts on improving search"; will want to clearly differentiate from Ask and reference help, so that patrons who need help soon can get it',
                ...
                logEventToAnalytics(e, t, n) {
                  window.ga && window.ga("send", "event", e, t, n);
                },
                logHelpEvent(e) {
                  const t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : window.location.pathname;
                  const n = "help-menu";
                  this.logMessage(
                    "logging '"
                      .concat(n, "' event with action: '")
                      .concat(e, "', label:'")
                      .concat(t, "'. [publish: ")
                      .concat(this.publishEvents, "]")
                  ),
                    this.publishEvents && this.logEventToAnalytics(n, e, t);
                },
                isNotificationDismissed() {
                  try {
                    ...
                    return !(
                      null === e ||
                      (Date.now() - e >= s.notificationIndicatorExpiration &&
                        (this.logMessage(
                          "'".concat(i, "' value is present, but has expired. removing it returning 'not dismissed'")
                        ),
                ...
                showNotificationIndicatorIfNotDismissed() {
                  this.enableNotificationIndicator &&
                    ...
                    document
                      ...
                      .style.setProperty("--notification-indicator-display", "inline-block"));
                },
                dismissNotificationIndicator() {
                  try {
                    this.enableNotificationIndicator &&
                      ...
                      document
                        .querySelector("help-menu-topbar")
                        .style.setProperty("--notification-indicator-display", "none"),
                ...
                get_entry_by_id(e) {
                  for (let t = 0; t < this.list_of_elements.length; t++)
                    if (this.list_of_elements[t].id === e) return this.list_of_elements[t];
                  for (let n = 0; n < this.list_of_updates.length; n++)
                    if (this.list_of_updates[n].id === e) return this.list_of_updates[n];
                  return {};
                },
                override_with_config(e) {
                  e &&
                    Object.keys(e) &&
                    (Object.keys(e).includes("logToConsole") && (this.logToConsole = e.logToConsole),
                    Object.keys(e).includes("publishEvents") && (this.publishEvents = e.publishEvents),
                    Object.keys(e).includes("enableNotificationIndicator") &&
                      (this.enableNotificationIndicator = e.enableNotificationIndicator),
                    Object.keys(e).includes("notificationIndicatorExpiration") &&
                      (this.notificationIndicatorExpiration = e.notificationIndicatorExpiration),
                    Object.keys(e).includes("helpMenuWidth") && (this.helpMenuWidth = e.helpMenuWidth),
                    Object.keys(e).includes("helpMenuTitle") && (this.helpMenuTitle = e.helpMenuTitle),
                    Object.keys(e).includes("logEventToAnalytics") &&
                      (this.logEventToAnalytics = e.logEventToAnalytics),
                    Object.keys(e).includes("entriesLabel") && (this.entriesLabel = e.entriesLabel),
                    Object.keys(e).includes("list_of_elements") && (this.list_of_elements = e.list_of_elements),
                    Object.keys(e).includes("updatesLabel") && (this.updatesLabel = e.updatesLabel),
                    Object.keys(e).includes("list_of_updates") && (this.list_of_updates = e.list_of_updates));
                },
              };
              var t = function (o, e, a, t, n) {
                let i = {};
                e.has("helpMenuConfig") && (i = e.get("helpMenuConfig")),
                  e.has(r) && (i = e.get(r)),
                  o.override_with_config(i),
                  (a.helpMenuTitle = o.helpMenuTitle),
                  (a.entriesLabel = o.entriesLabel),
                  (a.helpContentList = o.list_of_elements),
                  (a.updatesLabel = o.updatesLabel),
                  (a.helpContentUpdates = o.list_of_updates),
                  (a.hide = function () {
                    n.hide();
                  }),
                  (a.back = function () {
                    (a.entry = null), (window.top.location.hash = "");
                  }),
                  (a.openItem = function (e) {
                    const t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1];
                    (a.entry = o.get_entry_by_id(e)), t && o.logHelpEvent("select-item", e);
                  }),
                  (a.setEntryIdFromHash = function () {
                    const e = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0];
                    const t = window.location.hash.substring(1);
                    t && a.openItem(t, e);
                  }),
                  (a.openHelpInNewWindow = function () {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "";
                    let t = window.location.pathname;
                    let n = `/discovery/static-file/help${window.location.search}`;
                    e && ((n += `#${e}`), (t = e));
                    const i = o.helpMenuTitle || "Search Help Menu";
                    var e = "width=".concat(
                      o.helpMenuWidth,
                      ",height=800,resizable=0,location=0,menubar=0,scrollbars=yes"
                    );
                    o.logHelpEvent("open-window", t);
                    e = open(n, i, e);
                    (e.onload = function () {
                      this.document.title = i;
                    }),
                      e.addEventListener("hashchange", a.setEntryIdFromHash, !0),
                      a.hide();
                  }),
                  t(a.setEntryIdFromHash(!1), 10),
                  window.addEventListener("hashchange", a.setEntryIdFromHash, !0),
                  window.addEventListener("openHelpMenuEvent", (e) => {
                    e = e.detail || "";
                    o.logMessage(`opening helpMenu from 'openHelpMenuEvent' with 'item_id': '${e}'`),
                      a.openHelpInNewWindow(e);
                  });
              };
              angular
                .module("helpMenuContentDisplay", [])
                .constant("helpMenuHelper", s)
                ...
                .component("prmExploreFooterAfter", {
                  template: '\n      <help-menu-content-display>\n        <div ng-if="'
                    .concat(window.location.pathname.includes("/static-file/help"), '">')
                    .concat(n, "</div>\n      </help-menu-content-display>"),
                  controller: "helpMenuPopupController",
                }),
                angular
                  ...
                  .controller("helpMenuTopbarController", [
                    ...
                    function (n, e, i) {
                      let t = {};
                      e.has("helpMenuConfig") && (t = e.get("helpMenuConfig")),
                        e.has(r) && (t = e.get(r)),
                        n.override_with_config(t),
                        n.showNotificationIndicatorIfNotDismissed(),
                        (this.openHelpMenu = function (e) {
                          let t;
                          n.logHelpEvent("open-dialog", window.location.pathname),
                            n.dismissNotificationIndicator(),
                            i.show({
                              controller: "helpMenuDialogController",
                              template:
                                ((t = n.helpMenuWidth),
                                '\n  <md-dialog id="search-help-dialog" aria-label="Search Help Menu Dialog" style="width: '
                                  .concat(
                                    t,
          ...
          (o.t = function (t, e) {
            ...
            if (
              ...
              for (const i in t) o.d(n, i, ((e) => t[e]).bind(null, i));
            return n;
          }),
          (o.n = function (e) {
            const t =
        ...
        (i = "undefined" !== typeof self ? self : this),
          (o = function () {
            return (
              ...
              (o.m = n = [
                function (e, t, n) {
                  n(1), (e.exports = "searchBarSubMenu");
                },
                function (e, t, n) {
                  n.r(t),
                    angular
                        ...
                        function (e, t, n) {
                          (this.$onInit = function () {
                            ...
                            (t.translate = function (e) {
                              return e.replace(/\{(.+?)\}/g, (e, t) => n("translate")(t));
                            }),
          ...
          "object" === typeof n && "object" === typeof t
            ...
            ? define([], o)
            : "object" === typeof n
            ? (n.primoExploreCustomSearchBarSubMenu = o())
            : (i.primoExploreCustomSearchBarSubMenu = o());
      },
      {},
    ],
    5: [
        ...
        angular
          ...
          .controller("unpaywallController", [
            ...
            function (o, e) {
              ...
              let t = {};
              e.modules,
                e.has("unpaywallConfig") && (t = e.get("unpaywallConfig")),
                e.has("primoExploreUnpaywallStudioConfig") && (t = e.get("primoExploreUnpaywallStudioConfig")),
                (a.email = t.email || "primo-explore-unpaywall@npmjs.com"),
                (a.logToConsole = !Object.keys(t).includes("logToConsole") || t.logToConsole),
                (a.publishEvents = !!Object.keys(t).includes("publishEvents") && t.publishEvents),
                (a.showVersionLabel = !!Object.keys(t).includes("showVersionLabel") && t.showVersionLabel),
                (a.showDebugTable = !!Object.keys(t).includes("showDebugTable") && t.showDebugTable),
                (a.showOnResultsPage = !Object.keys(t).includes("showOnResultsPage") || t.showOnResultsPage),
                (a.overrideOACheck = !!Object.keys(t).includes("overrideOACheck") && t.overrideOACheck),
                (a.logEvent =
                  t.logEvent ||
                  function (e, t, n) {
                    window.ga && window.ga("send", "event", e, t, n);
                  }),
                (a.labelText = Object.keys(t).includes("labelText") ? t.labelText : null),
                (a.imageUrl = Object.keys(t).includes("imageUrl") ? t.imageUrl : null),
                (a.imageStyle = Object.keys(t).includes("imageStyle")
                  ? t.imageStyle
                  : "height: 24px; vertical-align: bottom; padding-right: 5px;"),
                (a.logMessageToConsole = function (e) {
                  a.logToConsole && console.log(`bulib-unpaywall) ${e}`);
                }),
                (a.logEventToAnalytics = function (e, t, n) {
                  a.logMessageToConsole(`triggering '${e}.${t}' event [publish=${a.publishEvents}].`),
                    a.publishEvents && a.logEvent(e, t, n);
                }),
                (a.trackLinkClick = function (e) {
                  a.logMessageToConsole(`unpaywall link used for doi: ${e}`),
                    a.logEventToAnalytics("unpaywall", "usage", a.listOrFullViewLabel);
                }),
                (a.$postLink = function () {
                  a.parentCtrl = a.prmSearchResultAvailabilityLine;
                  const e = a.parentCtrl.result;
                  const t = this.parentCtrl.isFullView || this.parentCtrl.isOverlayFullView;
                  (a.listOrFullViewLabel = t ? "full" : "list"), (a.show = t || a.showOnResultsPage);
                  try {
                    let n;
                    const i = e.pnx.addata;
                    i &&
                      ((this.doi = i.hasOwnProperty("doi") ? i.doi[0] : null), (this.is_oa = i.hasOwnProperty("oa"))),
                      this.doi &&
                        (!this.is_oa || a.overrideOACheck) &&
                        a.show &&
                        (a.logEventToAnalytics("unpaywall", "api-call", a.listOrFullViewLabel),
                        (n = `https://api.oadoi.org/v2/${a.doi}?email=${a.email}`),
                        a.logMessageToConsole(`-> making 'api-call' to ${n}`),
                        o.get(encodeURI(n)).then(
                          (e) => {
                            e = e.data.best_oa_location;
                            e &&
                              ((a.best_oa_link = e.url || ""),
                              a.logMessageToConsole(
                                `successfully acquired a 'best_oa_location' for doi '${a.doi}' at url: ${a.best_oa_link}`
                              ),
                              a.logEventToAnalytics("unpaywall", "api-success", a.listOrFullViewLabel),
                              (e = e.version.toLowerCase() || "").includes("publish")
                                ? (a.best_oa_version = "")
                                : (a.best_oa_version = e.includes("submit") ? "Submitted" : "Accepted"));
                          },
                          (e) => {
                            a.logMessageToConsole(
                              `[error status: ${e.status}] error calling unpaywall API: ${e.statusText}`
                            );
                          }
                        ));
                  } catch (e) {
                    a.logMessageToConsole(`error caught in unpaywallController: ${e.message}`);
                  }
                });
            },
          ])
        ...
        n.default = [
          {
            ...
            alt: "Worldcat Logo",
            mapping(e, t) {
              const i = { any: "kw", title: "ti", creator: "au", subject: "su", isbn: "bn", issn: "n2" };
              try {
    ...
    7: [
      function (e, t, n) {
        ...
        i = {
          logToConsole: !0,
          publishEvents: !1,
          enableNotificationIndicator: !0,
          notificationIndicatorExpiration: 12096e5,
          helpMenuTitle: "Get Help",
          updatesLabel: "What's New?",
          list_of_updates: o(e("./updates.constant")).default,
          entriesLabel: "Search Help",
          list_of_elements: i.default,
          helpMenuWidth: 500,
        };
        n.default = i;
      },
      { "./items.constant": 8, "./updates.constant": 9 },
    ],
    8: [
      function (e, t, n) {
        Object.defineProperty(n, "__esModule", { value: !0 }), (n.default = void 0);
    ...
    10: [
      function (e, t, n) {
        Object.defineProperty(n, "__esModule", { value: !0 }), (n.default = void 0);
        n.default = "<search-bar-sub-menu></search-bar-sub-menu>";
      },
      {},
    ],
    11: [
        ...
        n.default = [
          {
            ...
            icon: { set: "action", icon: "ic_info_24px" },
            show_xs: !0,
          ...
          },
          {
            ...
            icon: { set: "editor", icon: "ic_format_quote_24px" },
            show_xs: !0,
            cssClasses: "button-over-light",
          },
          {
            ...
            icon: { set: "action", icon: "ic_question_answer_24px" },
            show_xs: !0,
            cssClasses: "button-over-light",
          },
          {
            ...
            icon: { set: "action", icon: "ic_schedule_24px" },
            show_xs: !0,
            cssClasses: "button-over-light",
          },
          {
            ...
            icon: { set: "maps", icon: "ic_place_24px" },
            show_xs: !0,
            cssClasses: "button-over-light",
          },
          {
            ...
            icon: { set: "action", icon: "ic_search_24px" },
            show_xs: !0,
            cssClasses: "button-over-light",
          },
          {
    ...
    12: [
      function (e, t, n) {
        Object.defineProperty(n, "__esModule", { value: !0 }), (n.default = void 0);
        n.default = "<bulib-unpaywall></bulib-unpaywall>";
      },
      {},
    ],
    13: [
    ...
    14: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }), (n.default = void 0);
        const o = {
          template: ((i = e("../components/searchBarSubMenu/searchBarSubMenu.component")) && i.__esModule
            ? i
            : { default: i }
          ).default,
        };
      ...
      { "../components/searchBarSubMenu/searchBarSubMenu.component": 10 },
    ],
    15: [
      function (e, t, n) {
        let i;
        Object.defineProperty(n, "__esModule", { value: !0 }), (n.default = void 0);
        const o = {
          template: ((i = e("../components/unpaywall/unpaywall.component")) && i.__esModule ? i : { default: i })
            .default,
        };
        n.default = o;
      },
      { "../components/unpaywall/unpaywall.component": 12 },
    ],
    16: [
      function (e, t, n) {
        e("@orbis-cascade/primo-explore-external-search"),
          e("primo-explore-help-menu"),
          e("primo-explore-search-bar-sub-menu"),
          e("primo-explore-unpaywall");
        const i = c(e("./components/externalSearch/externalSearch.config"));
        const o = c(e("./components/helpMenu/helpMenu.config"));
        const a = c(e("./components/searchBarSubMenu/searchBarSubMenu.config"));
        const r = c(e("./components/unpaywall/unpaywall.config"));
        const s = c(e("./directives/prmSearchResultAvailabilityLineAfter.directive"));
        const l = c(e("./directives/prmSearchBarAfter.directive"));
        function c(e) {
          return e && e.__esModule ? e : { default: e };
        }
        e = angular.module("viewCustom", [
          "angularLoad",
          "externalSearch",
        ...
        !(function () {
          ...
          (e.type = "text/javascript"),
            (e.async = "true"),
            (e.src = "https://v2.libanswers.com/load_chat.php?hash=17b1fa99b577483a418172851f40a779");
          const t = document.getElementsByTagName("script")[0];
          t.parentNode.insertBefore(e, t);
        })(),
          e
            .constant("helpMenuConfig", o.default)
            .constant("searchBarSubMenuItems", a.default)
            .constant("unpaywallConfig", r.default)
            .component("prmSearchResultAvailabilityLineAfter", s.default)
            .component("prmSearchBarAfter", l.default)
            .value("searchTargets", i.default);
      },
      {
        "./components/externalSearch/externalSearch.config": 6,
        "./components/helpMenu/helpMenu.config": 7,
        "./components/searchBarSubMenu/searchBarSubMenu.config": 11,
        "./components/unpaywall/unpaywall.config": 13,
        "./directives/prmSearchBarAfter.directive": 14,
        "./directives/prmSearchResultAvailabilityLineAfter.directive": 15,
        "@orbis-cascade/primo-explore-external-search": 1,
        "primo-explore-help-menu": 3,
        "primo-explore-search-bar-sub-menu": 4,
        "primo-explore-unpaywall": 5,
      },
    ],
  },
  {},
